...
Также возможно получить доступ к атрибутам как к элементам массива, спасибо поддержке [ArrayAccess](http://php.net/manual/en/class.arrayaccess.php) и [Traversable](http://php.net/manual/en/class.arrayiterator.php)
в [[yii\base\Model]]:
...
// Модель явлется обходимой(traversable) с использованием foreach.
